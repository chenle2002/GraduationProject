...
from .views import load_target_data, get_topic_syntax, get_ipc_from_text, load_other_data, build_syntax_by_target, get_syntax_wenxinyiyan
...
urlpatterns = [
    ...
    path('getSyntaxWenxinyiyan/', get_syntax_wenxinyiyan, name='getSyntaxWenxinyiyan'),
]
